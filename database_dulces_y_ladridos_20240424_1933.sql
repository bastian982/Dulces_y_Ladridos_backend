...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `fk_orders_reviews1` FOREIGN KEY (`id_review`) REFERENCES `reviews` (`id_review`),
...
CREATE TABLE `orders_has_products` (
  ...
  CONSTRAINT `fk_orders_has_products_orders1` FOREIGN KEY (`id_order`) REFERENCES `orders` (`id_order`),
  CONSTRAINT `fk_orders_has_products_products1` FOREIGN KEY (`id_product`) REFERENCES `products` (`id_products`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `posts` (
  ...
  CONSTRAINT `fk_posts_categories_posts1` FOREIGN KEY (`id_category_post`) REFERENCES `categories_posts` (`id_category_post`),
...
CREATE TABLE `products` (
  ...
  CONSTRAINT `fk_products_categories_products1` FOREIGN KEY (`id_category_product`) REFERENCES `categories_products` (`id_category_product`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `reviews` (
  ...
  CONSTRAINT `fk_reviews_users1` FOREIGN KEY (`id_user`) REFERENCES `users` (`id_user`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `users_has_privileges`
--

DROP TABLE IF EXISTS `users_has_privileges`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `users_has_privileges` (
  `id_user_has_privilege` bigint NOT NULL AUTO_INCREMENT,
  `id_user` bigint NOT NULL,
  `id_privilege` bigint NOT NULL,
  PRIMARY KEY (`id_user_has_privilege`,`id_user`,`id_privilege`),
  KEY `fk_users_has_privileges_privileges1_idx` (`id_privilege`),
  KEY `fk_users_has_privileges_users_idx` (`id_user`),
  CONSTRAINT `fk_users_has_privileges_privileges1` FOREIGN KEY (`id_privilege`) REFERENCES `privileges` (`id_privilege`),
  CONSTRAINT `fk_users_has_privileges_users` FOREIGN KEY (`id_user`) REFERENCES `users` (`id_user`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `users_has_privileges`
--

LOCK TABLES `users_has_privileges` WRITE;
/*!40000 ALTER TABLE `users_has_privileges` DISABLE KEYS */;
/*!40000 ALTER TABLE `users_has_privileges` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-04-24 19:34:04
